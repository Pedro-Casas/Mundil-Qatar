...
public class Controlador implements ActionListener
{
    ...
    //------------
        ...
        public Controlador(VentanaPrincipal pVista, Equipo pModelo, Jugador pModelo2)
        {
            ...
            this.vista.miPanelOperaciones.btEntrenador.addActionListener(this);
        ...
        public void actionPerformed(ActionEvent ae) 
        {
            ...
            if(comando.equals("informacion"))
            {
                try 
                {
                    ...
                    vista.miPanelResultados.mostrarResultado("datos del equipo: \nPais = " + modelo.getPais() + "\nContinente = " + modelo.getContinente() + "\nParticipaciones = " + modelo.getParticipaciones() + "\nCopas = " + modelo.getCopas());
                    vista.miPanelOperaciones.activarBotones();
                
                } catch (Exception e) 
                {
                    JOptionPane.showMessageDialog(null, "Error en los datos","", JOptionPane.ERROR_MESSAGE);
                }
            }
