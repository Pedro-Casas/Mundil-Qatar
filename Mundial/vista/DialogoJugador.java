...
public class DialogoJugador extends JDialog
{
    ...
    private String[] posiciones = {"portero","interior derecho","central izquierdo","extremo izquierdo","extremo derecho","mediocentro","interior izquierdo","lateral izquierdo","lateral derecho","central derecho","Portero"};
    ...
    public DialogoJugador()
    {
        ...
        lbGoles = new JLabel("foles: ",JLabel.RIGHT);
        ...
        btOk = new JButton("Ok");
        btOk.setFont(new Font("Arial", Font.BOLD, 25));
        btOk.setBounds(200,220,200,25);
        btOk.setActionCommand("Ok");
        add(btOk);


        setTitle("info jugador");
        setSize(600,400);
